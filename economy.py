...
import random
import economic_functions

class Economy(object):
	def __init__(self):
		self.ef = economic_functions.EconomicFunctions()
	...
	def create_household(self):
		...
		exponents = self.ef.normalized_random_numbers(self.number_of_firms)
	...
	def assign_initial_inputs_weights(self):
		...
		for firm in self.firms_list:
			...
			weights = self.ef.normalized_random_numbers(how_many_random_numbers)
